...
const pokedex = require("./pokedex_jsons/00-pokedex.json");
const movesDB = require("./moves_jsons/00-moves.json");
const scarlet_violet_dex = require("../pokedexes/scVi/scarlet-violet-dex");
const manuallyWrittenPokemon = [79.1, 80.2, 128.1, 194.1];
/**
 * MAIN FUNCTION
 *
