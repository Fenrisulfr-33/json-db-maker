...
const { replaceWrongMoveNames } = require('./helperFunctions/replaceWrongMoveNames');
const { changePokedexEntriesData } = require('./helperFunctions/changePokedexEntriesData');
...
function pokedexRewrite() {
    ...
    pokedex.forEach((pokemon) => {
        ...
        pokemon.pokedexEntries = changePokedexEntriesData(pokemon.pokedexEntries, pokemon._id, errors);
    ...
    fs.writeFile('./06-pokedex.json', saveData, (error) => {
